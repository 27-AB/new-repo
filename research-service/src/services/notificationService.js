      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f5f5f5;">
        <div style="background: white; border-radius: 8px; padding: 30px; border-top: 4px solid #f59e0b;">
          ...
          <div style="margin-top: 20px; text-align: center;">
            <a href="http://localhost:3001/research" 
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f5f5f5;">
        <div style="background: white; border-radius: 8px; padding: 30px; border-top: 4px solid #991b1b;">
          ...
          <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0;">
            ...
            ${project.fundingETB ? `Budget: ${project.fundingETB.toLocaleString()} ETB` : ''}
          </div>
...
const checkUpcomingDeadlines = async () => {
  try {
    ...
    const projects = await Research.find({
...
const checkOverdueMilestones = async () => {
  try {
    ...
    for (const milestone of overdueMilestones) {
      const project = await Research.findById(milestone.projectId);
      if (!project) continue;
